...
\begin{textblock*}{20 cm}(0.5cm,1cm) % {block width} (coords)
    \textbf{MD-80 Systems}
    \\
    This is a placeholder file to test the website
    \\
    \textbf{Bibliografia:} SAS AOM, Delta AOM, LSH AOM.
\end{textblock*}
...
\begin{textblock*}{4cm}(0.5cm,5.5cm) % {block width} (coords)
   How many autpilots does the MD-80 have?
   \\
   \\
   What are the autoland capabilities of the MD-80
\end{textblock*}

% DIREITA
\begin{textblock*}{16cm}(05.25cm,5.5cm) % {block width} (coords)
   $\bigcdot$ The aircraft has 2 independent autopilot systems.
\\
\\
\\
   $\bigcdot$ Fail passive autoland.
\end{textblock*}
