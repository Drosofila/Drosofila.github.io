...
\cornell{Example Question}{Example Answer}

\cornell{Another research question}{\lipsum*[7]}

\cornell[Important]{This is easy to write?}{Even without \LyX{}, is not too hard fill this template, but you must compile twice.}
